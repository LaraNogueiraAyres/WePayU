...
public abstract class Empregado implements Serializable, Cloneable {
    ...
    public void setSindicalizado(boolean sindicalizado, String idSindicato, double taxaSindical) {
        if (sindicalizado) {
            this.membroSindicato = new MembroSindicato(idSindicato, taxaSindical);
        } else {
            this.membroSindicato = null;
        }
    }
    ...
    public String getMetodoPagamento() {
        if (metodoPagamento instanceof MetodoPagamentoEmMaos) {
            return "emMaos";
        } else if (metodoPagamento instanceof MetodoPagamentoBanco) {
            return "banco";
        } else if (metodoPagamento instanceof MetodoPagamentoCorreios) {
            return "correios";
        }
        return null;
    }
